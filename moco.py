...
def main():
    ...
    indices, acc = memory_bank_train.mine_nearest_neighbors(topk, calculate_accuracy=True)
    ...
    indices, acc = memory_bank_val.mine_nearest_neighbors(topk, calculate_accuracy=True)
